...
system [akma] (!_supi (phone_init: UE_initial (supi) | ntw_init: Core_initial (supi) | phone_kaf: UE_KAF (supi)) | !_af_id (ntw_kaf: Core_KAF (af_id) | af: AF (af_id))).
